...
Download the dataset boys.rda from the `mice` R package [here](https://github.com/amices/mice/tree/master/data) and then save it to the current working R directory.
```r
# Loading the data
data <- load("boys.rda")
